...
const ContentSection = () => {
  return (
      ...
      <section>
<section className="text-gray-400 bg-gray-900 body-font bg-BgColor text-TextColor">
  <div className="container px-5 py-24 mx-auto flex flex-col">
    <div className="lg:w-4/6 mx-auto">
      <div className="rounded-lg h-64 overflow-hidden">
        <img alt="content" className="object-cover object-center h-full w-full" src="logo/cc.jpeg"/>
      </div>
